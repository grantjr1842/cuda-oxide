...
| Distributed shared memory (`mapa.shared::cluster` / `cluster.sync`) | sm_90 | `contains_cluster_features` / `contains_cluster_sync` | `test_contains_cluster_features_detects_intrinsic`, `test_contains_cluster_sync_detects_instr`, `test_contains_cluster_sync_ignores_unrelated` |
...
| WGMMA (`wgmma.fence` / `wgmma.commit_group` / `wgmma.wait_group` / `wgmma.mma_async`) | sm_90a | `contains_wgmma_features` / `contains_wgmma_mma_async` / `contains_wgmma_fence` | `test_contains_wgmma_features_detects_intrinsic`, `test_contains_wgmma_features_ignores_unrelated`, `test_contains_wgmma_mma_async_detects_instr`, `test_contains_wgmma_mma_async_ignores_unrelated`, `test_contains_wgmma_fence_detects_instr`, `test_contains_wgmma_fence_ignores_unrelated` |
| tcgen05 / TMEM (Blackwell datacenter) | sm_100a | `contains_blackwell_features` / `contains_tcgen05_alloc` / `contains_tcgen05_mma` / `contains_tcgen05_fence` | `test_contains_blackwell_features_detects_intrinsic`, `test_tcgen05_alloc_detects_instr`, `test_tcgen05_alloc_ignores_unrelated`, `test_tcgen05_mma_detects_instr`, `test_tcgen05_mma_ignores_unrelated`, `test_tcgen05_fence_detects_instr`, `test_tcgen05_fence_ignores_unrelated` |
